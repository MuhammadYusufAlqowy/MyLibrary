...
class WormsIndicator @JvmOverloads constructor(
    ...
    init {
        ...
        if (attrs != null) {
            val a = getContext().obtainStyledAttributes(attrs, R.styleable.WormsIndicator)

            // Dots attributes
            dotIndicatorColor = a.getColor(R.styleable.WormsIndicator_dotsColor, dotIndicatorColor)
            dotsStrokeColor = a.getColor(R.styleable.WormsIndicator_dotsStrokeColor, dotIndicatorColor)

            // Spring dots attributes
            dotsStrokeWidth = a.getDimension(
                R.styleable.WormsIndicator_dotsStrokeWidth,
    ...
    private fun buildDot(stroke: Boolean): ViewGroup {
        ...
        dotImageView.setBackgroundResource(
            if (stroke) R.drawable.bg_worm else R.drawable.bg_worm_stroke
        )
