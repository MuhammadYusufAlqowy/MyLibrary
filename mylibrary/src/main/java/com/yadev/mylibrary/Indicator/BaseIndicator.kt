...
abstract class BaseIndicator @JvmOverloads constructor(
    ...
    enum class Type(val defaultSize: Float,
        ...
        DEFAULT(16f,
            8f,
            R.styleable.SpringsIndicator,
            R.styleable.SpringsIndicator_dotsColor,
            R.styleable.SpringsIndicator_dotsSize,
            R.styleable.SpringsIndicator_dotsSpacing,
            R.styleable.SpringsIndicator_dotsCornerRadius,
            R.styleable.SpringsIndicator_dotsClickable),
        SPRING(16f,
            4f,
        ...
        WORM(16f,
            4f,
            R.styleable.WormsIndicator,
            R.styleable.WormsIndicator_dotsColor,
            R.styleable.WormsIndicator_dotsSize,
            R.styleable.WormsIndicator_dotsSpacing,
            R.styleable.WormsIndicator_dotsCornerRadius,
            R.styleable.SpringsIndicator_dotsClickable)
    }
