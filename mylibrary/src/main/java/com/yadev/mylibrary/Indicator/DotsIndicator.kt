...
import com.yadev.mylibrary.setPaddingHorizontal
import com.yadev.mylibrary.setPaddingVertical
...
class DotsIndicator @JvmOverloads constructor(
    ...
    private fun init(attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            ...
            selectedDotColor = a.getColor(R.styleable.DotsIndicator_selectedDotColor,
                BaseIndicator.DEFAULT_POINT_COLOR
            )
    ...
    override val type get() = BaseIndicator.Type.DEFAULT
