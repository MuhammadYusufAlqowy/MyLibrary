...
class TextDrawable private constructor(builder: Builder) : ShapeDrawable(builder.shape) {
    ...
    class Builder : IConfigBuilder, IShapeBuilder, IBuilder {
        ...
        override fun withBorder(thickness: Int, borderColor: Int): IConfigBuilder {
            borderThickness = thickness
            this.borderColor = borderColor
            return this
        }

        override fun withBorder(thickness: Int, borderColor: String?): IConfigBuilder {
            borderThickness = thickness
    ...
    interface IConfigBuilder {
        ...
        fun withBorder(thickness: Int, borderColor: Int): IConfigBuilder
        fun withBorder(thickness: Int, borderColor: String?): IConfigBuilder
